...
public class SettingFragment extends BaseFragment implements ConfigListener, SiteListener, LiveListener, ThemeDialog.Listener {
    ...
    protected void initEvent() {
        ...
        // ===== 新增：重置应用 =====
        mBinding.resetApp.setOnClickListener(v -> showResetConfirmDialog());
    }
    ...
    private void showResetConfirmDialog() {
        new MaterialAlertDialogBuilder(requireActivity())
                ...
                .setPositiveButton(android.R.string.ok, (dialog, which) -> resetApp())
    ...
    private void resetApp() {
        ...
        requireContext().getSharedPreferences("video_settings", Context.MODE_PRIVATE).edit().clear().apply();
        ...
        deleteRecursive(requireContext().getFilesDir());
